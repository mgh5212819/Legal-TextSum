...
class Params:
  ...
  data_path: str = 'data/law_train.txt'
  val_data_path: Optional[str] = 'data/law_valid.txt'
  #max_src_len: int = 1000  # exclusive of special tokens such as EOS
  #max_tgt_len: int = 600 # exclusive of special tokens such as EOS
  ...
  model_path_prefix: Optional[str] = 'checkpoints/law'
  keep_every_epoch: bool = False  # save all epochs, or only the best and the latest one?

  # Testing
  beam_size: int = 4
  min_out_len: int = 60
  max_out_len: Optional[int] = 600
  out_len_in_words: bool = False
  test_data_path: str = 'test/input.json'
